...
public class TypeToJTypeConvertingVisitor extends
    ...
    private final Map<String, JDefinedClass> definedClassesMap;

    public TypeToJTypeConvertingVisitor(Map<String, JDefinedClass> definedClassesMap) {
        this.definedClassesMap = definedClassesMap;
    }
